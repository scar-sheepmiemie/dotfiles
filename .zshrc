...
#
# Generic, host-agnostic shell configuration.
# Company/project-specific config lives in ~/.zshrc.local.
# ====================================================================
...
# Source work/company-specific config if present (not tracked in this repo)
